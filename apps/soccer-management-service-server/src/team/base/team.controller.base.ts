...
import { PlayerProfileFindManyArgs } from "../../playerProfile/base/PlayerProfileFindManyArgs";
import { PlayerProfile } from "../../playerProfile/base/PlayerProfile";
...
export class TeamControllerBase {
  ...
  @common.Get("/:id/playerProfiles")
  @ApiNestedQuery(PlayerProfileFindManyArgs)
  async findPlayerProfiles(
    @common.Req() request: Request,
    @common.Param() params: TeamWhereUniqueInput
  ): Promise<PlayerProfile[]> {
    const query = plainToClass(PlayerProfileFindManyArgs, request.query);
    const results = await this.service.findPlayerProfiles(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/playerProfiles")
  async connectPlayerProfiles(
    @common.Param() params: TeamWhereUniqueInput,
    @common.Body() body: PlayerProfileWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      playerProfiles: {
        connect: body,
  ...
  @common.Patch("/:id/playerProfiles")
  ...
  @common.Delete("/:id/playerProfiles")
  async disconnectPlayerProfiles(
    @common.Param() params: TeamWhereUniqueInput,
    @common.Body() body: PlayerProfileWhereUniqueInput[]
  ): Promise<void> {
    const data = {
